...
import FriendChatList from "./FriendsChatList";
                          ...
                          >
                            ...
                            <li>
                              ...
                              <ul role="list" className="-mx-2 mt-2 space-y-1">
                                {sidebarOptions.map((option) => {
                                  ...
                                  return (
                                    <li key={option.name}>
                                      <Link
                                        href={option.href}
                                        className="text-gray-700 hover:text-primary hover:bg-slate-100 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold"
                                      >
                                ...
                                <li>
                                    <IncomingRequests
                                      unseenFriendRequests={unseenRequestCount}
                                      sessionId={session.user.id}
                                    />
                                </li>
                              </ul>
